        ...
        <div className="descriptionAndEstimatesList">
            ...
            >
                <div className="titleAndButton">
                    ...
                    {mobileScreens && activeList || mobileScreens && isContactFormOpen ? (
                        undefined
                    ) : largeLandscape && activeList || largeLandscape && isContactFormOpen || largePortrait && activeList || largePortrait && isContactFormOpen || activeList || isContactFormOpen ? <button
                        className="estimatesDisabled"
                        onClick={closeList}
                    >
                        Estimates
                    </button>
            ...
            {(largeLandscape || largePortrait) ? undefined : (mobileScreens && activeList === 'estimatesList') ? <EstimatesList setActiveList={setActiveList} /> : undefined}
        </div>
    )
}